...
# Project:C:\hlocal\SE\P2SE-C\Practica2SE\system.xmp
#
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) -intstyle $(INTSTYLE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_SIM_FILE_ARGS) -msg __xps/ise/xmsgprops.lst -s isim -X C:/hlocal/SE/P2SE-C/Practica2SE/
