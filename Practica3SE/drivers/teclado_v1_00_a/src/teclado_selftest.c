/*****************************************************************************
* Filename:          C:\hlocal\SE\p3\Practica3SE\Practica3SE/drivers/teclado_v1_00_a/src/teclado_selftest.c
* Version:           1.00.a
...
XStatus TECLADO_SelfTest(void * baseaddr_p)
{
  ...
  TECLADO_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = TECLADO_mReadSlaveReg1(baseaddr, 0);
  ...
  TECLADO_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = TECLADO_mReadSlaveReg2(baseaddr, 0);
  ...
  TECLADO_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = TECLADO_mReadSlaveReg3(baseaddr, 0);
